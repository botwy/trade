...
namespace trade
{
	partial class FormRegisterBuyBill
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.Name = "FormRegisterBuyBill";
			this.Text = "Приходные накладные - Журнал";
			this.Closing += new System.ComponentModel.CancelEventHandler(this.form_FormClosing);
